              ...
              <Table>
                <tr>
                  ...
                  <td>
                    ...
                    <p><strong>Revisão do pedido :</strong> <span >{ele.somedata}	</span></p>
                    <p><strong>Remover :</strong> <span ><i className='fas fa-trash' onClick={()=>dlt(ele.id)} style={{color:"red",fontSize:20,cursor:"pointer"}}></i>	</span></p>
                  </td>
                </tr>
              </Table>
            </div>
